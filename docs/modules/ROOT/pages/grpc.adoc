...
3. **Workflow ID as client name**: If a Quarkus gRPC client matching the workflow ID exists, it is used.
4. **Default channel**: If a Quarkus gRPC client named `flowGrpc` exists, it is used for all workflows.
